class Binusmaya:
    def __init__(self):
        self.Lecturer = [
            {'Name':'Mr. Jonsen', 'Subject':'Algorithm and Programing', 'LecturerID':'1234567'}, 
            {'Name':'Ir. Kikie ', 'Subject':'Boxing', 'LecturerID':'7267367'},
            {'Name':'Prof. Johan Kie', 'Subject':'Human Computer sarangheyo', 'LecturerID':'72222222'},
            {'Name':'Dr. oky prabudi', 'Subject':'Matimatika', 'LecturerID':'766644'},
        ]
...
test.tup_to_schedule('L1AC', '10 pm', 'Music')
